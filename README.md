...
A civic-tech initiative providing transparent access to municipal services, programs, and public funds of LGU Albay, Philippines, Philippines.
...
A **React + TypeScript** version of BetterAlbay.org is now available for contributors who prefer modern tooling and component-based architecture.
...
BetterAlbay.org is a volunteer-driven, open-source project that empowers the people of Albay with easy access to local government information. The platform aggregates public data from official government portals and presents it in a user-friendly, accessible format.

**Cost to the People of Albay = ₱0**

## Live Demo

Visit the live website: [https://betteralbay.org](https://betteralbay.org)
...
- Added Albay Quiz CTA section on homepage with branded Lottie animation (brand blue `#0032A0`)
- Added Albay Quiz link to footer Quick Links across all 51 HTML pages and React Footer
- Added Brief History of Albay interactive timeline section on homepage (1760–1957)
...
- Added 54 translation keys for Albay Quiz footer link across all page contexts
...
- Updated copyright year to 2026, name to "BetterAlbay.org"
- Footer copyright uses `flex-wrap: wrap; gap: 6px` layout with version badge right-aligned via `margin-left: auto`
- Removed trailing period after "BetterAlbay.org" from all pages and all 3 translation languages
...
We welcome contributions from everyone! Whether you're a developer, designer, data researcher, content writer, translator, or a concerned citizen of Albay, your participation helps shape this project for all.
...
- LGU Albay for public data availability and transparency
- All volunteers and contributors who dedicate their time
- Open-source community for the tools and libraries used
- Citizens of Albay for their feedback and support

---

Made for the people of Albay, Philippines

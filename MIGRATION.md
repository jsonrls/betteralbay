...
This document provides guidance for contributors migrating from the static HTML version to the React + TypeScript version of BetterAlbay.org.

## Overview

BetterAlbay.org now has two versions:
